  ...
  return (
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        <h1 className="crypto-coin-name">{cryptoDetails.name} ({cryptoDetails.symbol}) Price</h1>
        <p>
      ...
      <Col style={{marginTop: "60px"}} className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            <h1 className="coin-detailes-heading">{cryptoDetails.name} Value Statistics</h1>
            <p>
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            <h1 className="coin-detailes-heading">Other Statistics</h1>
            <p>
